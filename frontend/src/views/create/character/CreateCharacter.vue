...
<template>
  <div class="flex justify-center">
    <div class="card w-100 bg-base-100 shadow-sm mt-15">
      <div class="card-body ">
        <h3 class="text-lg front-bold">创建角色</h3>
        <Photo ref="photo-ref" />
        <Name ref="name-ref" />
        ...
        <div class="flex justify-center">
          <button @click="handleCreate" class="btn btn-neutral w-40 mt-2">创建</button>
        </div>
