  ...
  <fieldset class="fieldset">
    ...
    <div class="flex justify-center">
        ...
        <div class="avatar relative">
          <div v-if="myBackgroundImage" class="w-25 h-40 rounded-box">
            <img :src="myBackgroundImage" alt="">
          </div>
          <div v-else class="w-25 h-40 rounded-box bg-base-200"></div>
          <div @click="fileInputRef.click()" class="w-25 h-40 rounded-box absolute left-0 top-0 bg-black/20 flex justify-center items-center cursor-pointer">
            <CameraIcon />
          </div>
        </div>
    </div>
